...
public interface TweetSammlung {
	 ...
	 * @throws IOException
	 */
	void setStopwords(File file) throws FileNotFoundException, IOException;
	...
	/**
	 * @return Ein Iterator über die am häufigsten verwendeten #hashtags,
	 *         absteigend.
	 */
	Iterator<String> topHashTags();

	/**
	 * @return Ein Iterator über die am häufigsten verwendeten @mentions,
	 *         absteigend.
	 */
	Iterator<String> topWords();

	/**
	 * @return Ein Iterator ueber die Tweets, welche insgesamt die meisten
	 *         buzzwordigen woerter haben.
	 */
